//
//  DadosFinaisTableViewController.swift
//  MaePlanejaCliente
//
...
class DadosFinaisTableViewController: UITableViewController {
    let imgs = ["img01","img02","img03"]
    let produtos:[Produto] = [
        Produto(nome_item: "Fralda", preco: "R$ 20,00", imagem: "", mes: "3",imagens:imgs),
